(function(scope) {
    ...
    var Ajax = {
        ...
        submit: function(file, settings) {
            ...
            var upload = function(offset, count) {
                ...
                var formData = Ajax.getFormData(name, Ajax.getBlob(file, offset, end), data, {"start": offset, "end": end, "length": length});
                logger.debug("upload - name: " + name + ", range: " + range);
    ...
    FileUpload.prototype = {
        ...
        progress: function(fileId, loaded, total, speed, seconds) {
            this.logger.debug("FormUpload.progress - fileId: " + fileId + ", " + loaded + "/" + total + " - " + Math.floor(loaded / total * 100) + "%, " + speed + ", " + seconds);
            return Invokation.safe(this, this.settings, "progress", fileId, loaded, total, speed, seconds);
        },
         ...
         * @interface
         */
        abort: function(fileId, url, name, data) {
            throw UnsupportOperatorError;
        },
            ...
            try {
                ...
                var settings = {
                    ...
                    "progress": function(loaded, length) {
                        ...
                        self.progress(fileId, loaded, length, speed, fileItem.getSeconds());
                    },
                    "success": function(xhr) {
                    ...
                    "error": function(data) {
                        fileItem.status = 0;
                        self.error(fileItem.getItem(), data);
                    }
                };
                fileItem.status = 1;
